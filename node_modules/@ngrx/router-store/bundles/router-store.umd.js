...
(function (global, factory) {
    ...
    function _createRouterConfig(config) {
        return tslib.__assign({ stateKey: DEFAULT_ROUTER_FEATURENAME, serializer: MinimalRouterStateSerializer, navigationActionTiming: exports.NavigationActionTiming.PreActivation }, config);
    }
    var RouterTrigger;
    ...
    var StoreRouterConnectingModule = /** @class */ (function () {
        ...
        StoreRouterConnectingModule.prototype.dispatchRouterAction = function (type, payload) {
            ...
            try {
                this.store.dispatch({
                    type: type,
                    payload: tslib.__assign(tslib.__assign({ routerState: this.routerState }, payload), { event: this.config.routerState === 0 /* Full */
                            ? payload.event
