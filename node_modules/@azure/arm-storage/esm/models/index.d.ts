 ...
 * @enum {string}
 */
export declare type SkuName = 'Standard_LRS' | 'Standard_GRS' | 'Standard_RAGRS' | 'Standard_ZRS' | 'Premium_LRS' | 'Premium_ZRS';
/**
 ...
 * @enum {string}
 */
export declare type StorageAccountExpand = 'geoReplicationStats';
/**
 ...
 * Contains response data for the get operation.
 */
export declare type ManagementPoliciesGetResponse = StorageAccountManagementPolicies & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type ManagementPoliciesCreateOrUpdateResponse = StorageAccountManagementPolicies & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
