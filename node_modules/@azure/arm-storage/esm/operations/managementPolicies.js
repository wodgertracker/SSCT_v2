...
var ManagementPolicies = /** @class */ (function () {
    ...
    ManagementPolicies.prototype.createOrUpdate = function (resourceGroupName, accountName, options, callback) {
        return this.client.sendOperationRequest({
            resourceGroupName: resourceGroupName,
            accountName: accountName,
            options: options
...
var createOrUpdateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.ManagementPoliciesRulesSetParameter, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.StorageAccountManagementPolicies
